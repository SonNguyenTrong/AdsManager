...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.bulkInsert('users', [{ username: "admin",password:"admin", email:"admin@gmail.com",status:1}], {});
    await queryInterface.bulkInsert('shopify_accounts', [{ username: "admin@rosimall.com",password:"congdc17",user_id:1}], {});
